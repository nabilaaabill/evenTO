    ...
    <section class="event-categories">
        ...
        <div class="category-grid">
            ...
            <div class="category-card">
                ...
                <a href="visitor/birthday-events.php" class="btn">View Options</a>
            </div>
            ...
            <div class="category-card">
                ...
                <a href="visitor/wedding-events.php" class="btn">View Options</a>
            </div>
            ...
            <div class="category-card">
                ...
                <a href="visitor/festival-events.php" class="btn">View Options</a>
            </div>
        </div>
    </section>
    ...
    <div class="package-list">
      ...
      <div class="package-card">
        ...
        <div class="package-content">
          ...
          <a href="visitor/package.php?id=<?= $p['id'] ?>" class="btn">
            View Details
          </a>
        </div>
      </div>
